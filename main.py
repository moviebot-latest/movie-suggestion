...
DEFAULT_SERVERS = {
    "s1": {"name": "HdHub4u",     "url": os.getenv("SERVER_S1_URL", "https://new4.hdhub4u.fo/?s=")},
    "s2": {"name": "123Mkv",      "url": os.getenv("SERVER_S2_URL", "https://123mkv.bar/?s=")},
    "s3": {"name": "MkvCinemas",  "url": os.getenv("SERVER_S3_URL", "https://mkvcinemas.sb/?s=")},
    "s4": {"name": "WorldFree4u", "url": os.getenv("SERVER_S4_URL", "https://worldfree4u.ist/?s=")},
    "s5": {"name": "Bolly4u",     "url": os.getenv("SERVER_S5_URL", "https://bolly4u.gifts/?s=")},
    "s6": {"name": "FilmyZilla",  "url": os.getenv("SERVER_S6_URL", "https://filmyzilla.com.ph/?s=")},
}
...
async def _send_movie_card(update, context, data, reply_to=None, is_search=False):
    ...
    urls         = [servers.get(f"s{i}", _def_vals[i-1])["url"] + search_query for i in range(1, 7)]
