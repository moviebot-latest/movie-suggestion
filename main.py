# ╔══════════════════════════════════════════════════════════════════════╗
# ║            🎬 CineBot v7 — ALL BUGS FIXED + COMPLETE                ║
# ║                                                                      ║
# ║  ✅ V7 CHANGES (on top of v6):
# ║     • auto_delete: user_data cleanup param added (memory leak fix)
# ║     • log_search: while loop (was if) — all excess days pruned
# ║     • pick_cb: get_omdb wrapped in asyncio.to_thread
# ║     • review_cb: get_omdb wrapped in asyncio.to_thread
# ║     • funfact_cb: get_omdb wrapped in asyncio.to_thread
# ║     • random_cmd: get_omdb wrapped in asyncio.to_thread
# ║     • movie(): ALL 4 get_omdb/get_omdb_search calls → async
# ║     • daily_cmd: get_omdb wrapped in asyncio.to_thread
# ║     • _send_movie_card: auto_delete with user_data cleanup
# ║
# ║  🐛 ALL BUGS FIXED:                                                 ║
...
@web_app.route("/")
def home(): return "🎬 CineBot v6 Running"
...
print("✅ CineBot v7 Running — All 10 Bugs Fixed + Advanced Features Active!")
