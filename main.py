...
async def start_btn_cb(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if   cmd == "trending":     await trending_cmd(fake_update, context)
        ...
        await query.message.reply_text(
            ...
            "📝 *Apna mood batao:*\n\n"
            "Examples:\n"
            "_• Sad hoon, kuch emotional chahiye_\n"
            "_• Bored hoon, comedy chahiye_\n"
            "_• Family ke saath dekhni hai_\n\n/cancel_",
            parse_mode="Markdown"
        )
    elif cmd == "compare":
        await query.message.reply_text(
...
async def _send_movie_card(update, context, data, reply_to=None):
    ...
    send_fn = reply_to.reply_photo if reply_to else update.message.reply_photo
...
async def pick_cb(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data and data.get("Response") == "True":
        ...
        await _send_movie_card(fake, context, data)
    else:
...
async def random_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ✅ FIXED: delete loader AFTER data fetch
    try: await loader.delete()
    except: pass
